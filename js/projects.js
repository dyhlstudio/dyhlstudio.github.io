...
function fontScrambler() {
    var fonts = ["Gulax Regular", "iA Writer Mono", "stratos", "brevier", "Fluxisch Else Bold", "Ortica Light", "Happy Times at the IKOB New Game Plus Edition Italic", "Happy Times at the IKOB New Game Plus Edition"];
...
$(document).ready(function() {
    ...
    $('.link-wrapper').on('click tap', function() {
        ...
        $('.view-links').on('click tap', function() {
            ...
            // info button
            $('#info-link').on('click tap', function() {
                $('body').css('overflow', 'unset');
                onSlides = false;
                onInfo = true;
    ...
    $('#big-text').on('click tap', '.text-links', function() {
    ...
    $('.project-entry').on('click tap', function() {
        if (!($(this).hasClass('filtered'))) {
            $('.project-entry.filtered').removeClass('filtered');
        }
    });
