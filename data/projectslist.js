...
var projectsList = [
        ...
        "description": [
            ...
            "My responsibilities included the majority of the design, fabrication (with occasional support from collaborators: Lauren Jian, Lajja Mehta, Angie Mendoza, Aistyara Charmita Shaning, and Sherry Aine Te) and fully managing the creative production of the model through organizing collaborators, building relationships with external fabricators, makerspaces, and managing the budget all within a 6-week timeline from concept to completion."
        ],
        "assets": [
        ...
        "alt": [
            ...
            "Clay Workshop",
            "Exhibition Clay Models (credits: ANU Students)",
            "Exhibition Video & Drawing Installation (credits: ANU Students)",
            "Exhibition Setup",
            "Exhibition Intro Banner (credits: Sonal Beri)",
            "GSAPP & ANU Teams",
    ...
    },
    {
        ...
        "description": [
            ...
            "In fact, to circumvent the building of a $6 billion water filtration plant mandated by the US Government, the city established the NYCDEP: a police agency dedicated to ensuring purity of the water. For the rural towns that border the massive reservoir, city control has resulted in increased rent, economic distress, & displacement of the current descendants of those dispossessed in 1907 as the city continues to buy more land.",
            "On February 17, 2023, our studio gathered at the Olive Free Library in West Shokan (a hamlet of Olive, NY) with several Olive residents to learn first-hand of its history. In talking to them, we discovered complicated histories of loss, resistance, survival & commoning strategies that connect the reservoir community to each other.",
            "The consequent research at once explores strategies to sustain the “commons” from multi-scale design interventions centered around a proposed bus route that provides accessibility & mobility. But here unlike in more urban manifestations, the commons is not built through public parks, community buildings, & centralized forums of gathering. The research establishes the rural commons through embracing patchwork & decentralized networks of connection found in communities like Olive, in which one third of the population is over the age of 60, nearly everyone is working, & multiple cars are needed for basic day-to-day life. It also embraces moments of non-urban gathering, such as the converging of dispersed townsfolk throughout the day, in their individual cars, to the house in West Shokan where a husband and wife sell duck eggs at an unmanned stand along the road. Because while the couple must go to work, moments of connection like this are evidence of built trust & social capital in the community that allow for the community to reap the long-term benefits of the duck egg stand.",
    ...
    },
    {
        ...
        "description": [
            ...
            "The school encourages these pedagogical goals through an interconnected matrix of classroom “blocks.” Following phases of construction, parts of the school are incrementally built and occupiable at different stages. Built using site-derived earthen material, oblique terrains and interiors accommodate the plastic needs of children to fidget, hide, explode, and introspect. Classrooms flow horizontally to promote a mixing of different age ranges. Meanwhile, the mass and interiority found in lower levels dissipate into more open, porous spaces at the upper levels to accommodate programmatic needs from enclosed, safe retreats to open playscapes.",
        ...
        "alt": [
            ...
            "Site Analysis — Infrastructure & Materials",
            "Collage",
            "Collage",
            "Collage",
